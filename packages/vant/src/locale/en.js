const En = {
    ...
    form: {
        ...
        detailBtn: 'Whether to display the detail button',
        detailBtnText: 'Detail button text',
        detailBtnTextPlaceholder: 'View Details',
        detailBtnRouteName: 'Route name',
        detailBtnRouteNamePlaceholder: 'e.g.: ProjectImplementation',
    ...
    com: {
        ...
        datePicker: {
            ...
            props: {
                ...
                disabledNoGray: 'No gray when disabled',
                title: 'Top bar title',
                format: 'Display format',
                valueFormat: 'Format of the binding value',
