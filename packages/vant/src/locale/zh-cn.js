const ZhCn = {
    ...
    form: {
        ...
        resetBtn: '是否显示表单重置按钮',
        detailBtn: '是否显示查看详情按钮',
        detailBtnText: '查看详情按钮文字',
        detailBtnTextPlaceholder: '查看详情',
        detailBtnRouteName: '路由名称',
        detailBtnRouteNamePlaceholder: '例如：ProjectImplementation',
        appendChild: '添加子级',
        formMode: '表单模式',
        formName: '表单名称',
        componentMode: '生成组件',
